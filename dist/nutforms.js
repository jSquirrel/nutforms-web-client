	...
	var ModelRenderer = function () {
	    ...
	    _createClass(ModelRenderer, [{
	        ...
	        value: function render(htmlElement) {
	            ...
	            // Check for iterators
	            _DOMHelper2.default.findElementsWithAttribute(layoutDOM, "nf-field-iterator").forEach(function (iterator) {
	                var template = iterator.innerHTML;
	                var iteratorHTML = "";
	                while (attributeIterator.hasNext()) {
	                    var templateDOM = parser.parseFromString(template, "text/html");
	                    // Add explicit first
	                    _DOMHelper2.default.findElementsWithAttribute(templateDOM, "nf-field-widget").forEach(function (field) {
