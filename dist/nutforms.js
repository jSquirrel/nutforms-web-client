...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Nutforms = __webpack_require__(22);

	var _Nutforms2 = _interopRequireDefault(_Nutforms);

	var _NutformsActions = __webpack_require__(23);

	var NutformsActions = _interopRequireWildcard(_NutformsActions);

	var _ModelActions = __webpack_require__(24);

	var ModelActions = _interopRequireWildcard(_ModelActions);

	var _AttributeActions = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NutformsApiAspectsSource = function () {
	    ...
	    _createClass(NutformsApiAspectsSource, [{
	        ...
	        value: function fetchLocalizationData(entityName, locale) {
	            return fetch(this._buildUrl(this.LOCALIZATION_ENDPOINT + locale + '/' + entityName + '/new')) // TODO: remove the context
	            .then(this._toJson).then(this._logResponse("Localization data loaded from API"));
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AttributeBuilder = __webpack_require__(6);

	var _AttributeBuilder2 = _interopRequireDefault(_AttributeBuilder);

	var _RelationBuilder = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Observable2 = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Attribute = __webpack_require__(7);

	var _Attribute2 = _interopRequireDefault(_Attribute);

	var _AttributeRenderer = __webpack_require__(8);
	...
	var AttributeRenderer = function () {
	    ...
	    _createClass(AttributeRenderer, [{
	        ...
	        value: function getWidgetName() {
	            return this.attribute.model.widgetMapping(this.attribute.model.entityName, this.attribute.model.context, this.attribute.name, this.attribute.type, this.attribute.primary);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Relation = __webpack_require__(10);

	var _Relation2 = _interopRequireDefault(_Relation);

	var _AttributeBuilder2 = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Attribute2 = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AttributeIterator = __webpack_require__(12);
	...
	var AttributeIterator = function () {
	    ...
	    _createClass(AttributeIterator, [{
	        ...
	        value: function getByName(name) {
	            ...
	            for (var _i = 0; _i < this.attributes.length && result == null; ++_i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModelLocalization = __webpack_require__(17);

	var _ModelLocalization2 = _interopRequireDefault(_ModelLocalization);

	var _AttributeLocalization = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModelBuilder = __webpack_require__(3);

	var _ModelBuilder2 = _interopRequireDefault(_ModelBuilder);

	var _ModelRenderer = __webpack_require__(11);
	...
	var _Submit = __webpack_require__(25);
	...
	var _ModelStructureParser = __webpack_require__(14);

	var _ModelStructureParser2 = _interopRequireDefault(_ModelStructureParser);

	var _ValuesParser = __webpack_require__(15);

	var _ValuesParser2 = _interopRequireDefault(_ValuesParser);

	var _LocalizationParser = __webpack_require__(16);
	...
	var Nutforms = function (_Observable) {
	    ...
	    _createClass(Nutforms, [{
	        ...
	        value: function generateForm(htmlElement, entityName, locale, entityId, layout, widgetMapping, context) {
	            ...
	            Promise.all([this.aspectsSource.fetchStructureMetadata(entityName), this.aspectsSource.fetchLocalizationData(entityName, locale), this.aspectsSource.fetchValues(entityName, entityId), this.aspectsSource.fetchLayout(layout)]).then(function (values) {
	                ...
	                _this2.trigger(NutformsActions.FORM_RENDERED, model);
